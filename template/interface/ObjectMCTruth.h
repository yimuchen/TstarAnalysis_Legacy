#ifndef ObjectMCTRUTH_H
#define ObjectMCTRUTH_H 
...
int ObjectMCTruth(int ObjectIdx,GenInfoBranches GenInfo,PhotonInfoBranches ObjectInfo){
...
int ObjectMCTruth(int ObjectIdx,GenInfoBranches GenInfo,LepInfoBranches ObjectInfo){
...
int ObjectMCTruth(int ObjectIdx,GenInfoBranches GenInfo,JetInfoBranches ObjectInfo){
