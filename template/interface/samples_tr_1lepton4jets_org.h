...
struct sample_t SAMPLE[samples_order_size] = {
    ...
    /*
    {"./REDUCE_DATA/4leptons_GluGluToHToZZTo4L_M-126_8TeV-powheg-pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1.root",
        "ggToH2ZZTo4l", 290510 , 18.97*3.02*pow(10,-4), 0.50},   // okay (HIG-13-015)
    {"./REDUCE_DATA/4leptons_VBF_HToZZTo4L_M-126_8TeV-powheg-pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1.root",
        "VBFToH2ZZTo4l", 49614 , 1.568*3.02*pow(10,-4) , 0.50},   // okay (HIG-13-015)
    {"./REDUCE_DATA/4leptons_WH_HToZZTo4L_M-126_8TeV-pythia6_Summer12_DR53X-PU_S10_START53_V7C-v1.root",
        "WHToH2ZZTo4l", 151309 , 0.6860*3.02*pow(10,-4) , 0.50},   // okay (HIG-13-015)
    {"./REDUCE_DATA/4leptons_ZH_HToZZTo4L_M-126_8TeV-pythia6_Summer12_DR53X-PU_S10_START53_V7C-v1.root",
