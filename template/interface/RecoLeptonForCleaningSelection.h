#ifndef RecoLeptonForCleaningSelection_H 
#define RecoLeptonForCleaningSelection_H
...
void RecoLeptonForCleaningSelection(EvtInfoBranches EvtInfo, LepInfoBranches LepInfo, int &NMuons, int *M_Index, 
        int &NElectrons, int *E_Index,
