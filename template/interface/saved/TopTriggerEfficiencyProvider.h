...
class TopTriggerEfficiencyProvider{
 public:
  ...
  double get_weight(double lep_pt, double lep_eta, double jet_pt, double jet_eta, int npvertices, int njets, bool LepIsMuon, int JES=0, bool complete_dataset=1, double fractionA = 1., double fractionB = 1., double fractionC = 1., double fractionD = 1.);
 ...
 protected:
  ...
  double make_JetArray_JESScaleDown(int x, int y, int z, double fractionDatasets[4]);
  double make_JetArray_JESScaleUp(int x, int y, int z, double fractionDatasets[4]);
  ...
  double GetJetWeight(double pt, double eta, int njets, int JES,double fractionDatasets[4]);
