                    ...
                    if(JetInfo.Pt[J_Index[2]]>JetPtOrderCuts[irun_][2]){ 
                        ...
                        if(strcmp(SAMPLE[sample_idx].tag,DATA_TAG)) {
                            ...
                            if((EvtInfo.TrueIT[0])>=60){
                                ...
                                // TTG is PU with run depencies (PU_RD1)
                                if(sample_idx!=TTGJets_8TeV_madgraph_Summer12_DR53X_PU_S10_START53_V7A_v1)
                                    ...
                                    weight = WeightCorrectionOnTstar*weight_*LUMINOSITYForRuns[irun_]/LUMINOSITY;
                            }
